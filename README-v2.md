...
- `release-v1/`：初始版本，包含原始 MCP Server 和原始 README。
- `release-v2/`：第二版 MCP Server，新增配额监控能力，并更新安装与使用说明。

如果只想安装最新版，请优先使用 `release-v2/`。
...
```text
<release-v2 绝对路径>\.venv\Scripts\python.exe
```
